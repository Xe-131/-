...
from util import compute_angle
from util import is_point_in_polygon
...
# print()
# print(detection_result.hand_landmarks[0][0].x)
# print()
# print(detection_result.hand_world_landmarks[0][0])
# 
